from whatinstalled.installers.javascript.npm import NpmInstaller
from whatinstalled.installers.javascript.yarn import YarnInstaller


INSTALLERS = [NpmInstaller(), YarnInstaller("./")]
