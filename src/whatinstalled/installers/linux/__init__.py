from whatinstalled.installers.linux.dnf import DnfInstaller
from whatinstalled.installers.linux.dpkg import DpkgInstaller
from whatinstalled.installers.linux.yum import YumInstaller


INSTALLERS = [DnfInstaller(), DpkgInstaller(), YumInstaller()]
