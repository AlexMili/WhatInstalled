from whatinstalled.installers.mac.homebrew import HomebrewInstaller
from whatinstalled.installers.mac.pkgutil import PkgutilInstaller


INSTALLERS = [HomebrewInstaller(), PkgutilInstaller()]
